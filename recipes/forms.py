...
def __init__(self, *args, **kwargs):
    ...
    if self.instance:
        self.fields['excerpt'].initial = strip_html_tags(
            self.instance.excerpt)
        self.fields['ingredients'].initial = strip_html_tags(
            self.instance.ingredients)
        self.fields['instructions'].initial = strip_html_tags(
